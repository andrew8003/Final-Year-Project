        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="submit" name="add_days">Add Days</button>
                </td>
            </tr>
            <tr>
                <td>Force Return:</td>
                ...
                <input type="hidden" name="asset_id" value="<?php echo $borrow_row['asset_id']; ?>">
                <button type="submit" name="force_return">Force Return</button>
                </td>
            </tr>
        </table>
        </form>
